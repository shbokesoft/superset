(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["ChartList"],{
...
/***/ "./src/views/CRUD/chart/ChartList.tsx":
/*!********************************************!*\
  !*** ./src/views/CRUD/chart/ChartList.tsx ***!
  \********************************************/
/*! exports provided: default */
...
/* harmony import */ var _superset_ui_core__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @superset-ui/core */ "./node_modules/@superset-ui/core/esm/chart/registries/ChartMetadataRegistrySingleton.js");
...
/* harmony import */ var _superset_ui_core__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @superset-ui/core */ "./node_modules/@superset-ui/core/esm/style/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var rison__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! rison */ "./node_modules/rison/js/rison.js");
/* harmony import */ var rison__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(rison__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var src_featureFlags__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! src/featureFlags */ "./src/featureFlags.ts");
/* harmony import */ var src_views_CRUD_utils__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! src/views/CRUD/utils */ "./src/views/CRUD/utils.tsx");
/* harmony import */ var src_views_CRUD_hooks__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! src/views/CRUD/hooks */ "./src/views/CRUD/hooks.ts");
/* harmony import */ var src_components_ConfirmStatusChange__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! src/components/ConfirmStatusChange */ "./src/components/ConfirmStatusChange/index.tsx");
/* harmony import */ var src_components_Menu_SubMenu__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! src/components/Menu/SubMenu */ "./src/components/Menu/SubMenu.tsx");
/* harmony import */ var src_components_FaveStar__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! src/components/FaveStar */ "./src/components/FaveStar/index.tsx");
/* harmony import */ var src_components_ListView__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! src/components/ListView */ "./src/components/ListView/index.ts");
/* harmony import */ var src_utils_localStorageHelpers__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! src/utils/localStorageHelpers */ "./src/utils/localStorageHelpers.ts");
/* harmony import */ var src_messageToasts_enhancers_withToasts__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! src/messageToasts/enhancers/withToasts */ "./src/messageToasts/enhancers/withToasts.tsx");
/* harmony import */ var src_explore_components_PropertiesModal__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! src/explore/components/PropertiesModal */ "./src/explore/components/PropertiesModal/index.tsx");
...
/* harmony import */ var src_components_Tooltip__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! src/components/Tooltip */ "./src/components/Tooltip/index.tsx");
...
/* harmony import */ var src_dashboard_components_nativeFilters_utils__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! src/dashboard/components/nativeFilters/utils */ "./src/dashboard/components/nativeFilters/utils.ts");
/* harmony import */ var _ChartCard__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./ChartCard */ "./src/views/CRUD/chart/ChartCard.tsx");
/* harmony import */ var _emotion_react__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! @emotion/react */ "./node_modules/@emotion/react/dist/emotion-react.browser.esm.js");
(function () {var enterModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.enterModule : undefined;enterModule && enterModule(module);})();var __signature__ = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default.signature : function (a) {return a;}; /**
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
...
const PAGE_SIZE = 25;
const PASSWORDS_NEEDED_MESSAGE = Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('The passwords for the databases below are needed in order to ' +
'import them together with the charts. Please note that the ' +
'"Secure Extra" and "Certificate" sections of ' +
'the database configuration are not present in export files, and ' +
'should be added manually after the import if they are needed.');
const CONFIRM_OVERWRITE_MESSAGE = Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('You are importing one or more charts that already exist. ' +
'Overwriting might cause you to lose some of your work. Are you ' +
'sure you want to overwrite?');
const registry = Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_7__["default"])();
const createFetchDatasets = handleError => async (filterValue = '', pageIndex, pageSize) => {
  ...
  try {var _json$result;
    const queryParams = rison__WEBPACK_IMPORTED_MODULE_11___default.a.encode({
    ...
    const { json = {} } = await _superset_ui_core__WEBPACK_IMPORTED_MODULE_8__["default"].get({
      endpoint: `/api/v1/dataset/?q=${queryParams}` });

    const datasets = json == null ? void 0 : (_json$result = json.result) == null ? void 0 : _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_4___default()(_json$result).call(_json$result, ({ table_name: tableName, id }) => ({
      label: tableName,
      value: id }));

    return lodash_uniqBy__WEBPACK_IMPORTED_MODULE_5___default()(datasets, 'value');
  }
  catch (e) {
    handleError(e);
  }
...
const Actions = _superset_ui_core__WEBPACK_IMPORTED_MODULE_9__["styled"].div`
  color: ${({ theme }) => theme.colors.grayscale.base};
`;
function ChartList(props) {var _context, _context2, _context3;
  const { addDangerToast, addSuccessToast } = props;
  const { state: { loading, resourceCount: chartCount, resourceCollection: charts, bulkSelectEnabled }, setResourceCollection: setCharts, hasPerm, fetchData, toggleBulkSelect, refreshData } = Object(src_views_CRUD_hooks__WEBPACK_IMPORTED_MODULE_14__["useListViewResource"])('chart', Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('chart'), addDangerToast);
  const chartIds = Object(react__WEBPACK_IMPORTED_MODULE_10__["useMemo"])(() => _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_4___default()(charts).call(charts, c => c.id), [charts]);
  const [saveFavoriteStatus, favoriteStatus] = Object(src_views_CRUD_hooks__WEBPACK_IMPORTED_MODULE_14__["useFavoriteStatus"])('chart', chartIds, addDangerToast);
  const { sliceCurrentlyEditing, handleChartUpdated, openChartEditModal, closeChartEditModal } = Object(src_views_CRUD_hooks__WEBPACK_IMPORTED_MODULE_14__["useChartEditModal"])(setCharts, charts);
  const [importingChart, showImportModal] = Object(react__WEBPACK_IMPORTED_MODULE_10__["useState"])(false);
  const [passwordFields, setPasswordFields] = Object(react__WEBPACK_IMPORTED_MODULE_10__["useState"])([]);
  ...
  const canExport = hasPerm('can_read') && Object(src_featureFlags__WEBPACK_IMPORTED_MODULE_12__["isFeatureEnabled"])(src_featureFlags__WEBPACK_IMPORTED_MODULE_12__["FeatureFlag"].VERSIONED_EXPORT);
  const initialSort = [{ id: 'changed_on_delta_humanized', desc: true }];
  function handleBulkChartDelete(chartsToDelete) {
    _superset_ui_core__WEBPACK_IMPORTED_MODULE_8__["default"].delete({
      endpoint: `/api/v1/chart/?q=${rison__WEBPACK_IMPORTED_MODULE_11___default.a.encode(_babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_4___default()(chartsToDelete).call(chartsToDelete, ({ id }) => id))}` }).
    then(({ json = {} }) => {
      refreshData();
      addSuccessToast(json.message);
    }, Object(src_views_CRUD_utils__WEBPACK_IMPORTED_MODULE_13__["createErrorHandler"])(errMsg => addDangerToast(Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('There was an issue deleting the selected charts: %s', errMsg))));
  }
  const columns = Object(react__WEBPACK_IMPORTED_MODULE_10__["useMemo"])(() => [
  ...(props.user.userId ?
  [
  {
    Cell: ({ row: { original: { id } } }) => Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])(src_components_FaveStar__WEBPACK_IMPORTED_MODULE_17__["default"], { itemId: id, saveFaveStar: saveFavoriteStatus, isStarred: favoriteStatus[id] }),
    Header: '',
    id: 'id',
    disableSortBy: true,
    size: 'xs' }] :
  ...
  []),
  {
    Cell: ({ row: { original: { url, slice_name: sliceName } } }) => Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])("a", { href: url, "data-test": `${sliceName}-list-chart-title` },
    sliceName),

    Header: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Chart'),
    accessor: 'slice_name' },

  {
    ...
    Header: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Visualization type'),
    accessor: 'viz_type',
    size: 'xxl' },

  {
    Cell: ({ row: { original: { datasource_name_text: dsNameTxt, datasource_url: dsUrl } } }) => Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])("a", { href: dsUrl }, dsNameTxt),
    Header: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Dataset'),
    accessor: 'datasource_id',
    disableSortBy: true,
    size: 'xl' },

  {
    Cell: ({ row: { original: { changed_by_name: changedByName, changed_by_url: changedByUrl } } }) => Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])("a", { href: changedByUrl }, changedByName),
    Header: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Modified by'),
    accessor: 'changed_by.first_name',
    size: 'xl' },

  {
    Cell: ({ row: { original: { changed_on_delta_humanized: changedOn } } }) => Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])("span", { className: "no-wrap" }, changedOn),
    Header: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Last modified'),
...

  {
    ...
    Header: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Created by'),
    accessor: 'created_by',
    disableSortBy: true,
    size: 'xl' },
  ...
  {
    Cell: ({ row: { original } }) => {
      const handleDelete = () => Object(src_views_CRUD_utils__WEBPACK_IMPORTED_MODULE_13__["handleChartDelete"])(original, addSuccessToast, addDangerToast, refreshData);
      const openEditModal = () => openChartEditModal(original);
      const handleExport = () => Object(src_views_CRUD_utils__WEBPACK_IMPORTED_MODULE_13__["handleBulkChartExport"])([original]);
      if (!canEdit && !canDelete && !canExport) {
        return null;
      }
      return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])(Actions, { className: "actions" },
      canDelete && Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])(src_components_ConfirmStatusChange__WEBPACK_IMPORTED_MODULE_15__["default"], { title: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Please confirm'), description: Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])(react__WEBPACK_IMPORTED_MODULE_10___default.a.Fragment, null,
        Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Are you sure you want to delete'), ' ',
        Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])("b", null, original.slice_name), "?"),
        onConfirm: handleDelete },
      confirmDelete => Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])(src_components_Tooltip__WEBPACK_IMPORTED_MODULE_23__["Tooltip"], { id: "delete-action-tooltip", title: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Delete'), placement: "bottom" },
      Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])("span", { "data-test": "trash", role: "button", tabIndex: 0, className: "action-button", onClick: confirmDelete },
      Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])(src_components_Icons__WEBPACK_IMPORTED_MODULE_24__["default"].Trash, null)))),



      canExport && Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])(src_components_Tooltip__WEBPACK_IMPORTED_MODULE_23__["Tooltip"], { id: "export-action-tooltip", title: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Export'), placement: "bottom" },
      Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])("span", { role: "button", tabIndex: 0, className: "action-button", onClick: handleExport },
      Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])(src_components_Icons__WEBPACK_IMPORTED_MODULE_24__["default"].Share, null))),


      canEdit && Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])(src_components_Tooltip__WEBPACK_IMPORTED_MODULE_23__["Tooltip"], { id: "edit-action-tooltip", title: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Edit'), placement: "bottom" },
      Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])("span", { role: "button", tabIndex: 0, className: "action-button", onClick: openEditModal },
      Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])(src_components_Icons__WEBPACK_IMPORTED_MODULE_24__["default"].EditAlt, { "data-test": "edit-alt" }))));



    },
    Header: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Actions'),
    id: 'actions',
    disableSortBy: true,
  ...
  const favoritesFilter = {
    Header: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Favorite'),
    id: 'id',
    urlDisplay: 'favorite',
    input: 'select',
    operator: src_components_ListView__WEBPACK_IMPORTED_MODULE_18__["FilterOperator"].chartIsFav,
    unfilteredLabel: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Any'),
    selects: [
    { label: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Yes'), value: true },
    { label: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('No'), value: false }] };


  const filters = [
  {
    Header: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Owner'),
    id: 'owners',
    input: 'select',
    operator: src_components_ListView__WEBPACK_IMPORTED_MODULE_18__["FilterOperator"].relationManyMany,
    unfilteredLabel: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('All'),
    fetchSelects: Object(src_views_CRUD_utils__WEBPACK_IMPORTED_MODULE_13__["createFetchRelated"])('chart', 'owners', Object(src_views_CRUD_utils__WEBPACK_IMPORTED_MODULE_13__["createErrorHandler"])(errMsg => addDangerToast(Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('An error occurred while fetching chart owners values: %s', errMsg))), props.user.userId),
    paginate: true },

  {
    ...
    id: 'created_by',
    input: 'select',
    operator: src_components_ListView__WEBPACK_IMPORTED_MODULE_18__["FilterOperator"].relationOneMany,
    unfilteredLabel: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('All'),
    fetchSelects: Object(src_views_CRUD_utils__WEBPACK_IMPORTED_MODULE_13__["createFetchRelated"])('chart', 'created_by', Object(src_views_CRUD_utils__WEBPACK_IMPORTED_MODULE_13__["createErrorHandler"])(errMsg => addDangerToast(Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('An error occurred while fetching chart created by values: %s', errMsg))), props.user.userId),
    paginate: true },

  {
    Header: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Viz type'),
    id: 'viz_type',
    input: 'select',
    operator: src_components_ListView__WEBPACK_IMPORTED_MODULE_18__["FilterOperator"].equals,
    unfilteredLabel: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('All'),
    selects: _babel_runtime_corejs3_core_js_stable_instance_sort__WEBPACK_IMPORTED_MODULE_3___default()(_context = _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_4___default()(_context2 = _babel_runtime_corejs3_core_js_stable_instance_filter__WEBPACK_IMPORTED_MODULE_2___default()(_context3 = _babel_runtime_corejs3_core_js_stable_instance_keys__WEBPACK_IMPORTED_MODULE_1___default()(registry).call(registry)).call(_context3,

    k => {var _registry$get2;return Object(src_dashboard_components_nativeFilters_utils__WEBPACK_IMPORTED_MODULE_25__["nativeFilterGate"])(((_registry$get2 = registry.get(k)) == null ? void 0 : _registry$get2.behaviors) || []);})).call(_context2,
...

  {
    ...
    operator: src_components_ListView__WEBPACK_IMPORTED_MODULE_18__["FilterOperator"].equals,
    unfilteredLabel: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('All'),
    fetchSelects: createFetchDatasets(Object(src_views_CRUD_utils__WEBPACK_IMPORTED_MODULE_13__["createErrorHandler"])(errMsg => addDangerToast(Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('An error occurred while fetching chart dataset values: %s', errMsg)))),
    paginate: false },

  ...(props.user.userId ? [favoritesFilter] : []),
  {
    Header: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Search'),
    id: 'slice_name',
    input: 'search',
    operator: src_components_ListView__WEBPACK_IMPORTED_MODULE_18__["FilterOperator"].chartAllText }];
  ...
  const sortTypes = [
  {
    desc: false,
    id: 'slice_name',
    label: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Alphabetical'),
    value: 'alphabetical' },

  {
    desc: true,
    id: 'changed_on_delta_humanized',
    label: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Recently modified'),
    value: 'recently_modified' },

  {
    desc: false,
    id: 'changed_on_delta_humanized',
    label: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Least recently modified'),
    value: 'least_recently_modified' }];


  function renderCard(chart) {
    const { userId } = props.user;
    const userKey = Object(src_utils_localStorageHelpers__WEBPACK_IMPORTED_MODULE_19__["getFromLocalStorage"])(userId.toString(), null);
    return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])(_ChartCard__WEBPACK_IMPORTED_MODULE_26__["default"], { chart: chart, showThumbnails: userKey ?
      userKey.thumbnails :
      Object(src_featureFlags__WEBPACK_IMPORTED_MODULE_12__["isFeatureEnabled"])(src_featureFlags__WEBPACK_IMPORTED_MODULE_12__["FeatureFlag"].THUMBNAILS), hasPerm: hasPerm, openChartEditModal: openChartEditModal, bulkSelectEnabled: bulkSelectEnabled, addDangerToast: addDangerToast, addSuccessToast: addSuccessToast, refreshData: refreshData, loading: loading, favoriteStatus: favoriteStatus[chart.id], saveFavoriteStatus: saveFavoriteStatus });
  }
  const subMenuButtons = [];
  if (canDelete || canExport) {
    subMenuButtons.push({
      name: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Bulk select'),
  ...
  if (canCreate) {
    subMenuButtons.push({
      name: Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])(react__WEBPACK_IMPORTED_MODULE_10___default.a.Fragment, null,
      Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])("i", { className: "fa fa-plus" }), " ", Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Chart')),
  ...
  if (Object(src_featureFlags__WEBPACK_IMPORTED_MODULE_12__["isFeatureEnabled"])(src_featureFlags__WEBPACK_IMPORTED_MODULE_12__["FeatureFlag"].VERSIONED_EXPORT)) {
    subMenuButtons.push({
      name: Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])(src_components_Tooltip__WEBPACK_IMPORTED_MODULE_23__["Tooltip"], { id: "import-tooltip", title: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Import charts'), placement: "bottomRight" },
      Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])(src_components_Icons__WEBPACK_IMPORTED_MODULE_24__["default"].Import, { "data-test": "import-button" })),

      buttonStyle: 'link',
      onClick: openChartImportModal });

  }
  return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])(react__WEBPACK_IMPORTED_MODULE_10___default.a.Fragment, null,
  Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])(src_components_Menu_SubMenu__WEBPACK_IMPORTED_MODULE_16__["default"], { name: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Charts'), buttons: subMenuButtons }),
  sliceCurrentlyEditing && Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])(src_explore_components_PropertiesModal__WEBPACK_IMPORTED_MODULE_21__["default"], { onHide: closeChartEditModal, onSave: handleChartUpdated, show: true, slice: sliceCurrentlyEditing }),
  Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])(src_components_ConfirmStatusChange__WEBPACK_IMPORTED_MODULE_15__["default"], { title: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Please confirm'), description: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Are you sure you want to delete the selected charts?'), onConfirm: handleBulkChartDelete },
  confirmDelete => {
    const bulkActions = [];
    if (canDelete) {
      bulkActions.push({
        key: 'delete',
        name: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Delete'),
        type: 'danger',
    ...
    if (canExport) {
      bulkActions.push({
        key: 'export',
        name: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('Export'),
        type: 'primary',
        onSelect: src_views_CRUD_utils__WEBPACK_IMPORTED_MODULE_13__["handleBulkChartExport"] });

    }
    return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])(src_components_ListView__WEBPACK_IMPORTED_MODULE_18__["default"], { bulkActions: bulkActions, bulkSelectEnabled: bulkSelectEnabled, cardSortSelectOptions: sortTypes, className: "chart-list-view", columns: columns, count: chartCount, data: charts, disableBulkSelect: toggleBulkSelect, fetchData: fetchData, filters: filters, initialSort: initialSort, loading: loading, pageSize: PAGE_SIZE, renderCard: renderCard, defaultViewMode: Object(src_featureFlags__WEBPACK_IMPORTED_MODULE_12__["isFeatureEnabled"])(src_featureFlags__WEBPACK_IMPORTED_MODULE_12__["FeatureFlag"].LISTVIEWS_DEFAULT_CARD_VIEW) ?
      'card' :
      'table' });
  }),


  Object(_emotion_react__WEBPACK_IMPORTED_MODULE_27__["jsx"])(src_components_ImportModal_index__WEBPACK_IMPORTED_MODULE_22__["default"], { resourceName: "chart", resourceLabel: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["t"])('chart'), passwordsNeededMessage: PASSWORDS_NEEDED_MESSAGE, confirmOverwriteMessage: CONFIRM_OVERWRITE_MESSAGE, addDangerToast: addDangerToast, addSuccessToast: addSuccessToast, onModelImport: handleChartImport, show: importingChart, onHide: closeChartImportModal, passwordFields: passwordFields, setPasswordFields: setPasswordFields }));

}__signature__(ChartList, "useListViewResource{{ state: { loading, resourceCount: chartCount, resourceCollection: charts, bulkSelectEnabled, }, setResourceCollection: setCharts, hasPerm, fetchData, toggleBulkSelect, refreshData, }}\nuseMemo{chartIds}\nuseFavoriteStatus{[saveFavoriteStatus, favoriteStatus]}\nuseChartEditModal{{ sliceCurrentlyEditing, handleChartUpdated, openChartEditModal, closeChartEditModal, }}\nuseState{[importingChart, showImportModal](false)}\nuseState{[passwordFields, setPasswordFields]([])}\nuseMemo{columns}", () => [src_views_CRUD_hooks__WEBPACK_IMPORTED_MODULE_14__["useListViewResource"], src_views_CRUD_hooks__WEBPACK_IMPORTED_MODULE_14__["useFavoriteStatus"], src_views_CRUD_hooks__WEBPACK_IMPORTED_MODULE_14__["useChartEditModal"]]);const _default =
Object(src_messageToasts_enhancers_withToasts__WEBPACK_IMPORTED_MODULE_20__["default"])(ChartList);/* harmony default export */ __webpack_exports__["default"] = (_default);;(function () {var reactHotLoader = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default : undefined;if (!reactHotLoader) {return;}reactHotLoader.register(PAGE_SIZE, "PAGE_SIZE", "G:\\workspace\\boke-pro\\superset-all\\superset\\superset-frontend\\src\\views\\CRUD\\chart\\ChartList.tsx");reactHotLoader.register(PASSWORDS_NEEDED_MESSAGE, "PASSWORDS_NEEDED_MESSAGE", "G:\\workspace\\boke-pro\\superset-all\\superset\\superset-frontend\\src\\views\\CRUD\\chart\\ChartList.tsx");reactHotLoader.register(CONFIRM_OVERWRITE_MESSAGE, "CONFIRM_OVERWRITE_MESSAGE", "G:\\workspace\\boke-pro\\superset-all\\superset\\superset-frontend\\src\\views\\CRUD\\chart\\ChartList.tsx");reactHotLoader.register(registry, "registry", "G:\\workspace\\boke-pro\\superset-all\\superset\\superset-frontend\\src\\views\\CRUD\\chart\\ChartList.tsx");reactHotLoader.register(createFetchDatasets, "createFetchDatasets", "G:\\workspace\\boke-pro\\superset-all\\superset\\superset-frontend\\src\\views\\CRUD\\chart\\ChartList.tsx");reactHotLoader.register(Actions, "Actions", "G:\\workspace\\boke-pro\\superset-all\\superset\\superset-frontend\\src\\views\\CRUD\\chart\\ChartList.tsx");reactHotLoader.register(ChartList, "ChartList", "G:\\workspace\\boke-pro\\superset-all\\superset\\superset-frontend\\src\\views\\CRUD\\chart\\ChartList.tsx");reactHotLoader.register(_default, "default", "G:\\workspace\\boke-pro\\superset-all\\superset\\superset-frontend\\src\\views\\CRUD\\chart\\ChartList.tsx");})();;(function () {var leaveModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.leaveModule : undefined;leaveModule && leaveModule(module);})();
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../../node_modules/webpack/buildin/harmony-module.js */ "./node_modules/webpack/buildin/harmony-module.js")(module)))

/***/ })

}]);
//# sourceMappingURL=ChartList.9ed865ea.chunk.js.map