...
`;function u({actions:e}){return Object(l.d)(c,{className:"actions"},s()(e).call(e,(e,t)=>{const a=o.a[e.icon];return e.tooltip?Object(l.d)(r.a,{id:`${e.label}-tooltip`,title:e.tooltip,placement:e.placement,key:t},Object(l.d)(d,{role:"button",tabIndex:0,className:"action-button",onClick:e.onClick},Object(l.d)(a,null))):Object(l.d)(d,{role:"button",tabIndex:0,className:"action-button",onClick:e.onClick,key:t},Object(l.d)(a,null))}))}},4319:function(e,t,a){"use strict";a(52);var n=a(14),s=a.n(n),i=a(0),r=a.n(i),o=a(65),l=a(18),c=a(74),d=a(163),u=a(826),b=a(1);Object(o.g)(c.a)`
...
`;function x({addDangerToast:e,addSuccessToast:t,children:a,...n}){return Object(f.d)(w,null,Object(f.d)(y.a,{tabIndex:0,name:"copy",role:"button",onClick:n=>{var s;n.preventDefault(),n.currentTarget.blur(),s=a,Object(v.a)(s).then(()=>{t&&t(Object(r.e)("SQL Copied!"))}).catch(()=>{e&&e(Object(r.e)("Sorry, your browser does not support copying."))})}}),Object(f.d)(j.a,s()({style:h.a},n),a))}},4417:function(e,t,a){"use strict";a.d(t,"a",(function(){return r}));a(52);var n=a(835),s=a.n(n),i=a(0);function r({queries:e,fetchData:t,currentQueryId:a}){const n=s()(e).call(e,e=>e.id===a),[r,o]=Object(i.useState)(n),[l,c]=Object(i.useState)(!1),[d,u]=Object(i.useState)(!1);function b(){c(0===r),u(r===e.length-1)}function p(a){const n=r+(a?-1:1);n>=0&&n<e.length&&(t(e[n].id),o(n),b())}return Object(i.useEffect)(()=>{b()}),{handleKeyPress:function(t){r>=0&&r<e.length&&("ArrowDown"===t.key||"k"===t.key?(t.preventDefault(),p(!1)):"ArrowUp"!==t.key&&"j"!==t.key||(t.preventDefault(),p(!0)))},handleDataChange:p,disablePrevious:l,disableNext:d}}},4772:function(e,t,a){"use strict";a.r(t);a(52);var n=a(39),s=a.n(n),i=a(14),r=a.n(i),o=a(18),l=a(65),c=a(134),d=a(0),u=a.n(d),b=a(178),p=a.n(b),g=a(12),m=a.n(g),h=a(187),O=a(233),j=a(191),y=a(826),v=a(3493),f=a(1399),w=a(4312),x=a(3494),k=a(4318),S=a(68),N=a(4328),_=a(529),E=a(49),C=a(4319),q=a(103),D=a(163),$=a(62),T=a(4416),M=a(4417),I=a(1);const R=l.g.div`
