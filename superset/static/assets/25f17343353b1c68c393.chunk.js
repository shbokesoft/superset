...
`;function x({addDangerToast:e,addSuccessToast:t,children:a,...n}){return Object(v.d)(_,null,Object(v.d)(f.a,{tabIndex:0,name:"copy",role:"button",onClick:n=>{var s;n.preventDefault(),n.currentTarget.blur(),s=a,Object(y.a)(s).then(()=>{t&&t(Object(r.e)("SQL Copied!"))}).catch(()=>{e&&e(Object(r.e)("Sorry, your browser does not support copying."))})}}),Object(v.d)(j.a,s()({style:p.a},n),a))}},4541:function(e,t,a){"use strict";a.d(t,"a",(function(){return r}));a(52);var n=a(836),s=a.n(n),i=a(0);function r({queries:e,fetchData:t,currentQueryId:a}){const n=s()(e).call(e,e=>e.id===a),[r,c]=Object(i.useState)(n),[l,o]=Object(i.useState)(!1),[d,u]=Object(i.useState)(!1);function b(){o(0===r),u(r===e.length-1)}function g(a){const n=r+(a?-1:1);n>=0&&n<e.length&&(t(e[n].id),c(n),b())}return Object(i.useEffect)(()=>{b()}),{handleKeyPress:function(t){r>=0&&r<e.length&&("ArrowDown"===t.key||"k"===t.key?(t.preventDefault(),g(!1)):"ArrowUp"!==t.key&&"j"!==t.key||(t.preventDefault(),g(!0)))},handleDataChange:g,disablePrevious:l,disableNext:d}}},5262:function(e,t,a){"use strict";a.r(t);a(52);var n,s=a(14),i=a.n(s),r=a(0),c=a.n(r),l=a(67),o=a(18),d=a(134),u=a(12),b=a.n(u),g=a(188),m=a(192),h=a(828),p=a(1405),O=a(233),j=a(4374),f=a(4337),y=a(74),v=a(71),_=a(567),x=a.n(_),w=a(1282),q=a.n(w),k=a(998),S=a.n(k),N=a(182);!function(e){e.id="id",e.changed_on="changed_on",e.database="database",e.database_name="database.database_name",e.schema="schema",e.sql="sql",e.executed_sql="exceuted_sql",e.sql_tables="sql_tables",e.status="status",e.tab_name="tab_name",e.user="user",e.user_first_name="user.first_name",e.start_time="start_time",e.end_time="end_time",e.rows="rows",e.tmp_table_name="tmp_table_name",e.tracking_url="tracking_url"}(n||(n={}));var $=a(164),E=a(7),D=a.n(E),C=a(62),M=a(4540),T=a(4541),L=a(1);const H=l.g.div`
