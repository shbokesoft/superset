...
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PluginFilterGroupBy; });
...
function PluginFilterGroupBy(props) {
  ...
  const handleChange = value => {
    const resultValue = Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_3__["default"])(value);
  ...
  }, [_babel_runtime_corejs3_core_js_stable_json_stringify__WEBPACK_IMPORTED_MODULE_2___default()(filterState.value), multiSelect]);
  Object(react__WEBPACK_IMPORTED_MODULE_5__["useEffect"])(() => {
    handleChange(defaultValue != null ? defaultValue : null);
    // I think after Config Modal update some filter it re-creates default value for all other filters
    // so we can process it like this `JSON.stringify` or start to use `Immer`
  }, [_babel_runtime_corejs3_core_js_stable_json_stringify__WEBPACK_IMPORTED_MODULE_2___default()(defaultValue), multiSelect]);
  const columns = data || [];
  const placeholderText = columns.length === 0 ?
  Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_4__["t"])('No columns') :
  Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_4__["tn"])('%s option', '%s options', columns.length, columns.length);
  ...
  Object(_emotion_react__WEBPACK_IMPORTED_MODULE_8__["jsx"])(_common__WEBPACK_IMPORTED_MODULE_7__["StyledSelect"], { allowClear: true, value: value, placeholder: placeholderText, mode: multiSelect ? 'multiple' : undefined
    // @ts-ignore
    , onChange: handleChange, onBlur: unsetFocusedFilter, onFocus: setFocusedFilter, ref: inputRef },
  _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_1___default()(columns).call(columns, row => {
    const { column_name: columnName, verbose_name: verboseName } = row;
    return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_8__["jsx"])(Option, { key: columnName, value: columnName },
    verboseName != null ? verboseName : columnName);

  })));


}__signature__(PluginFilterGroupBy, "useState{[value, setValue](defaultValue ?? [])}\nuseEffect{}\nuseEffect{}");;(function () {var reactHotLoader = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default : undefined;if (!reactHotLoader) {return;}reactHotLoader.register(Option, "Option", "G:\\workspace\\boke-pro\\superset-all\\superset\\superset-frontend\\src\\filters\\components\\GroupBy\\GroupByFilterPlugin.tsx");reactHotLoader.register(PluginFilterGroupBy, "PluginFilterGroupBy", "G:\\workspace\\boke-pro\\superset-all\\superset\\superset-frontend\\src\\filters\\components\\GroupBy\\GroupByFilterPlugin.tsx");})();;(function () {var leaveModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.leaveModule : undefined;leaveModule && leaveModule(module);})();
...
//# sourceMappingURL=52.9ed865ea.chunk.js.map