(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["ExecutionLog"],{
...
/***/ "./src/views/CRUD/alert/ExecutionLog.tsx":
/*!***********************************************!*\
  !*** ./src/views/CRUD/alert/ExecutionLog.tsx ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var _babel_runtime_corejs3_core_js_stable_instance_slice__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js-stable/instance/slice */ "./node_modules/@babel/runtime-corejs3/core-js-stable/instance/slice.js");
...
/* harmony import */ var src_components_ListView__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/components/ListView */ "./src/components/ListView/index.ts");
/* harmony import */ var src_components_Menu_SubMenu__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/components/Menu/SubMenu */ "./src/components/Menu/SubMenu.tsx");
...
/* harmony import */ var src_modules_dates__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/modules/dates */ "./src/modules/dates.js");
/* harmony import */ var src_views_CRUD_alert_components_AlertStatusIcon__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/views/CRUD/alert/components/AlertStatusIcon */ "./src/views/CRUD/alert/components/AlertStatusIcon.tsx");
...
const PAGE_SIZE = 25;
const StyledHeader = _superset_ui_core__WEBPACK_IMPORTED_MODULE_1__["styled"].div`
  display: flex;
  flex-direction: row;
...
function ExecutionLog({ addDangerToast, isReportEnabled }) {
  const { alertId } = Object(react_router_dom__WEBPACK_IMPORTED_MODULE_5__["useParams"])();
  const { state: { loading, resourceCount: logCount, resourceCollection: logs }, fetchData } = Object(src_views_CRUD_hooks__WEBPACK_IMPORTED_MODULE_12__["useListViewResource"])(`report/${alertId}/log`, Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_2__["t"])('log'), addDangerToast, false);
  const { state: { loading: alertLoading, resource: alertResource }, fetchResource } = Object(src_views_CRUD_hooks__WEBPACK_IMPORTED_MODULE_12__["useSingleViewResource"])('report', Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_2__["t"])('reports'), addDangerToast);
  ...
  {
    Cell: ({ row: { original: { state } } }) => Object(_emotion_react__WEBPACK_IMPORTED_MODULE_13__["jsx"])(src_views_CRUD_alert_components_AlertStatusIcon__WEBPACK_IMPORTED_MODULE_11__["default"], { state: state, isReportEnabled: isReportEnabled }),
    accessor: 'state',
    Header: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_2__["t"])('State'),
    size: 'xs',
    disableSortBy: true },

  {
    Cell: ({ row: { original: { uuid: executionId } } }) => executionId ? _babel_runtime_corejs3_core_js_stable_instance_slice__WEBPACK_IMPORTED_MODULE_0___default()(executionId).call(executionId, 0, 6) : 'none',
    accessor: 'uuid',
    Header: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_2__["t"])('Execution ID'),
    size: 'xs',
    disableSortBy: true },

  {
    Cell: ({ row: { original: { scheduled_dttm: scheduledDttm } } }) => moment__WEBPACK_IMPORTED_MODULE_3___default()(new Date(scheduledDttm)).format('YYYY-MM-DD hh:mm:ss a'),
    accessor: 'scheduled_dttm',
    Header: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_2__["t"])('Scheduled at (UTC)') },

  {
    Cell: ({ row: { original: { start_dttm: startDttm } } }) => moment__WEBPACK_IMPORTED_MODULE_3___default()(new Date(startDttm)).format('YYYY-MM-DD hh:mm:ss a'),
    Header: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_2__["t"])('Start at (UTC)'),
    accessor: 'start_dttm' },

  {
    Cell: ({ row: { original: { start_dttm: startDttm, end_dttm: endDttm } } }) => Object(src_modules_dates__WEBPACK_IMPORTED_MODULE_10__["fDuration"])(new Date(startDttm).getTime(), new Date(endDttm).getTime()),
    Header: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_2__["t"])('Duration'),
    disableSortBy: true },

  {
    accessor: 'value',
    Header: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_2__["t"])('Value') },

  {
    accessor: 'error_message',
    Header: Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_2__["t"])('Error message') }],

  [isReportEnabled]);
  const path = `/${isReportEnabled ? 'report' : 'alert'}/list/`;
  return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_13__["jsx"])(react__WEBPACK_IMPORTED_MODULE_4___default.a.Fragment, null,
  Object(_emotion_react__WEBPACK_IMPORTED_MODULE_13__["jsx"])(src_components_Menu_SubMenu__WEBPACK_IMPORTED_MODULE_8__["default"], { name: Object(_emotion_react__WEBPACK_IMPORTED_MODULE_13__["jsx"])(StyledHeader, null,
    Object(_emotion_react__WEBPACK_IMPORTED_MODULE_13__["jsx"])("span", null,
    Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_2__["t"])(`${alertResource == null ? void 0 : alertResource.type}`), " ", alertResource == null ? void 0 : alertResource.name),

    Object(_emotion_react__WEBPACK_IMPORTED_MODULE_13__["jsx"])("span", null,
    Object(_emotion_react__WEBPACK_IMPORTED_MODULE_13__["jsx"])(react_router_dom__WEBPACK_IMPORTED_MODULE_6__["Link"], { to: path }, "Back to all"))) }),


  Object(_emotion_react__WEBPACK_IMPORTED_MODULE_13__["jsx"])(src_components_ListView__WEBPACK_IMPORTED_MODULE_7__["default"], { className: "execution-log-list-view", columns: columns, count: logCount, data: logs, fetchData: fetchData, initialSort: initialSort, loading: loading, pageSize: PAGE_SIZE }));

}__signature__(ExecutionLog, "useParams{{ alertId }}\nuseListViewResource{{ state: { loading, resourceCount: logCount, resourceCollection: logs }, fetchData, }}\nuseSingleViewResource{{ state: { loading: alertLoading, resource: alertResource }, fetchResource, }}\nuseEffect{}\nuseMemo{columns}", () => [react_router_dom__WEBPACK_IMPORTED_MODULE_5__["useParams"], src_views_CRUD_hooks__WEBPACK_IMPORTED_MODULE_12__["useListViewResource"], src_views_CRUD_hooks__WEBPACK_IMPORTED_MODULE_12__["useSingleViewResource"]]);const _default =
Object(src_messageToasts_enhancers_withToasts__WEBPACK_IMPORTED_MODULE_9__["default"])(ExecutionLog);/* harmony default export */ __webpack_exports__["default"] = (_default);;(function () {var reactHotLoader = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default : undefined;if (!reactHotLoader) {return;}reactHotLoader.register(PAGE_SIZE, "PAGE_SIZE", "G:\\workspace\\boke-pro\\superset-all\\superset\\superset-frontend\\src\\views\\CRUD\\alert\\ExecutionLog.tsx");reactHotLoader.register(StyledHeader, "StyledHeader", "G:\\workspace\\boke-pro\\superset-all\\superset\\superset-frontend\\src\\views\\CRUD\\alert\\ExecutionLog.tsx");reactHotLoader.register(ExecutionLog, "ExecutionLog", "G:\\workspace\\boke-pro\\superset-all\\superset\\superset-frontend\\src\\views\\CRUD\\alert\\ExecutionLog.tsx");reactHotLoader.register(_default, "default", "G:\\workspace\\boke-pro\\superset-all\\superset\\superset-frontend\\src\\views\\CRUD\\alert\\ExecutionLog.tsx");})();;(function () {var leaveModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.leaveModule : undefined;leaveModule && leaveModule(module);})();
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../../node_modules/webpack/buildin/harmony-module.js */ "./node_modules/webpack/buildin/harmony-module.js")(module)))
...
//# sourceMappingURL=ExecutionLog.9ed865ea.chunk.js.map