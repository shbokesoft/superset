...
function u(o){var i=Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(o),u=i[1];return[i[0],Object(react__WEBPACK_IMPORTED_MODULE_1__["useCallback"])(function(n){u(Object(immer__WEBPACK_IMPORTED_MODULE_0__["default"])(n))},[])]}function e(n,t,u){var e=Object(react__WEBPACK_IMPORTED_MODULE_1__["useMemo"])(function(){return Object(immer__WEBPACK_IMPORTED_MODULE_0__["default"])(n)},[n]);return Object(react__WEBPACK_IMPORTED_MODULE_1__["useReducer"])(e,t,u)}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PluginFilterSelect; });
/* harmony import */ var core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.iterator.js */ "./node_modules/core-js/modules/web.dom-collections.iterator.js");
/* harmony import */ var core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _babel_runtime_corejs3_core_js_stable_instance_some__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js-stable/instance/some */ "./node_modules/@babel/runtime-corejs3/core-js-stable/instance/some.js");
...
/* harmony import */ var _superset_ui_core__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @superset-ui/core */ "./node_modules/@superset-ui/core/esm/chart/types/Base.js");
/* harmony import */ var _superset_ui_core__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @superset-ui/core */ "./node_modules/@superset-ui/core/esm/time-format/formatters/smartDateDetailed.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var src_common_components__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/common/components */ "./src/common/components/index.tsx");
...
/* harmony import */ var src_components_Icons__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! src/components/Icons */ "./src/components/Icons/index.tsx");
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../common */ "./src/filters/components/common.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../utils */ "./src/filters/utils.ts");
...
const { Option } = src_common_components__WEBPACK_IMPORTED_MODULE_11__["Select"];
...
function PluginFilterSelect(props) {var _context;
  ...
  const groupby = Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["default"])(formData.groupby);
  const [col] = groupby;
  const [initialColtypeMap] = Object(react__WEBPACK_IMPORTED_MODULE_10__["useState"])(coltypeMap);
  const [selectedValues, setSelectedValues] = Object(react__WEBPACK_IMPORTED_MODULE_10__["useState"])(filterState.value);
  const sortedData = Object(react__WEBPACK_IMPORTED_MODULE_10__["useMemo"])(() => {
    const firstData = [];
    const restData = [];
    _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_5___default()(data).call(data, row => {
      // @ts-ignore
      if (selectedValues != null && _babel_runtime_corejs3_core_js_stable_instance_includes__WEBPACK_IMPORTED_MODULE_4___default()(selectedValues).call(selectedValues, row[col])) {
        firstData.push(row);
      } else
      {
        restData.push(row);
  ...
  const [isDropdownVisible, setIsDropdownVisible] = Object(react__WEBPACK_IMPORTED_MODULE_10__["useState"])(false);
  const [currentSuggestionSearch, setCurrentSuggestionSearch] = Object(react__WEBPACK_IMPORTED_MODULE_10__["useState"])('');
  const [dataMask, dispatchDataMask] = Object(use_immer__WEBPACK_IMPORTED_MODULE_14__["useImmerReducer"])(reducer, {
    extraFormData: {},
    filterState });

  const updateDataMask = Object(react__WEBPACK_IMPORTED_MODULE_10__["useCallback"])(values => {
    const emptyFilter = enableEmptyFilter && !inverseSelection && !(values != null && values.length);
    const suffix = inverseSelection && values != null && values.length ? ` (${Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_7__["t"])('excluded')})` : '';
    dispatchDataMask({
      type: 'filterState',
      __cache: filterState,
      extraFormData: Object(_utils__WEBPACK_IMPORTED_MODULE_17__["getSelectExtraFormData"])(col, values, emptyFilter, inverseSelection),
      filterState: {
        label: `${(values || []).join(', ')}${suffix}`,
        value: appSection === _superset_ui_core__WEBPACK_IMPORTED_MODULE_8__["AppSection"].FILTER_CONFIG_MODAL && defaultToFirstItem ?
        undefined :
        values } });
  ...
  enableEmptyFilter,
  inverseSelection,
  _babel_runtime_corejs3_core_js_stable_json_stringify__WEBPACK_IMPORTED_MODULE_3___default()(filterState)]);
  ...
  const isDisabled = appSection === _superset_ui_core__WEBPACK_IMPORTED_MODULE_8__["AppSection"].FILTER_CONFIG_MODAL && defaultToFirstItem;
  const debouncedOwnStateFunc = Object(react__WEBPACK_IMPORTED_MODULE_10__["useCallback"])(lodash_debounce__WEBPACK_IMPORTED_MODULE_12___default()(val => {
    dispatchDataMask({
      type: 'ownState',
      ownState: {
  ...
  }, src_constants__WEBPACK_IMPORTED_MODULE_13__["SLOW_DEBOUNCE"]), []);
  ...
  const labelFormatter = Object(_utils__WEBPACK_IMPORTED_MODULE_17__["getDataRecordFormatter"])({
    timeFormatter: _superset_ui_core__WEBPACK_IMPORTED_MODULE_9__["default"] });

  const handleChange = value => {
    const values = Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["default"])(value);
    if (values.length === 0) {
      updateDataMask(null);
    } else
    {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_10__["useEffect"])(() => {
    if (defaultToFirstItem && filterState.value === undefined) {
      ...
      _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_2___default()(groupby).call(groupby, col => data[0][col]) :
      null;
  ...
  }, [_babel_runtime_corejs3_core_js_stable_json_stringify__WEBPACK_IMPORTED_MODULE_3___default()(dataMask)]);
  const placeholderText = data.length === 0 ?
  Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_7__["t"])('No data') :
  Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_7__["tn"])('%s option', '%s options', data.length, data.length);
  const Icon = inverseSelection ? src_components_Icons__WEBPACK_IMPORTED_MODULE_15__["default"].StopOutlined : src_components_Icons__WEBPACK_IMPORTED_MODULE_15__["default"].CheckOutlined;
  return Object(_emotion_react__WEBPACK_IMPORTED_MODULE_18__["jsx"])(_common__WEBPACK_IMPORTED_MODULE_16__["Styles"], { height: height, width: width },
  Object(_emotion_react__WEBPACK_IMPORTED_MODULE_18__["jsx"])(_common__WEBPACK_IMPORTED_MODULE_16__["StyledSelect"], { allowClear: !enableEmptyFilter
    // @ts-ignore
    ...
    // @ts-ignore
    , onChange: handleChange, ref: inputRef, loading: isRefreshing, maxTagCount: 5, menuItemSelectedIcon: Object(_emotion_react__WEBPACK_IMPORTED_MODULE_18__["jsx"])(Icon, { iconSize: "m" }) },
  _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_2___default()(sortedData).call(sortedData, row => {
    const [value] = _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_2___default()(groupby).call(groupby, col => row[col]);
    return (
      // @ts-ignore
      Object(_emotion_react__WEBPACK_IMPORTED_MODULE_18__["jsx"])(Option, { key: `${value}`, value: value },
      labelFormatter(value, datatype)));

  }),
  currentSuggestionSearch &&
  !_babel_runtime_corejs3_core_js_stable_instance_some__WEBPACK_IMPORTED_MODULE_1___default()(_context = Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_6__["default"])(filterState.value)).call(_context, suggestion => suggestion === currentSuggestionSearch) && Object(_emotion_react__WEBPACK_IMPORTED_MODULE_18__["jsx"])(Option, { value: currentSuggestionSearch },
  `${Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_7__["t"])('Create "%s"', currentSuggestionSearch)}`)));



}__signature__(PluginFilterSelect, "useState{[initialColtypeMap](coltypeMap)}\nuseState{[selectedValues, setSelectedValues](filterState.value)}\nuseMemo{sortedData}\nuseState{[isDropdownVisible, setIsDropdownVisible](false)}\nuseState{[currentSuggestionSearch, setCurrentSuggestionSearch]('')}\nuseImmerReducer{[dataMask, dispatchDataMask]}\nuseCallback{updateDataMask}\nuseEffect{}\nuseCallback{debouncedOwnStateFunc}\nuseEffect{}\nuseEffect{}", () => [use_immer__WEBPACK_IMPORTED_MODULE_14__["useImmerReducer"]]);;(function () {var reactHotLoader = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default : undefined;if (!reactHotLoader) {return;}reactHotLoader.register(Option, "Option", "G:\\workspace\\boke-pro\\superset-all\\superset\\superset-frontend\\src\\filters\\components\\Select\\SelectFilterPlugin.tsx");reactHotLoader.register(reducer, "reducer", "G:\\workspace\\boke-pro\\superset-all\\superset\\superset-frontend\\src\\filters\\components\\Select\\SelectFilterPlugin.tsx");reactHotLoader.register(PluginFilterSelect, "PluginFilterSelect", "G:\\workspace\\boke-pro\\superset-all\\superset\\superset-frontend\\src\\filters\\components\\Select\\SelectFilterPlugin.tsx");})();;(function () {var leaveModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.leaveModule : undefined;leaveModule && leaveModule(module);})();
...
//# sourceMappingURL=44.9ed865ea.chunk.js.map