...
/* harmony default export */ __webpack_exports__["default"] = (Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_0__["default"])(_Sunburst__WEBPACK_IMPORTED_MODULE_1__["default"]));
...
var content = __webpack_require__(/*! !../../../css-loader??ref--7-1!./Sunburst.css */ "./node_modules/css-loader/index.js?!./node_modules/@superset-ui/legacy-plugin-chart-sunburst/esm/Sunburst.css");
...
/* harmony import */ var _superset_ui_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @superset-ui/core */ "./node_modules/@superset-ui/core/esm/color/SequentialSchemeRegistrySingleton.js");
...
/* harmony import */ var _Sunburst_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Sunburst.css */ "./node_modules/@superset-ui/legacy-plugin-chart-sunburst/esm/Sunburst.css");
/* harmony import */ var _Sunburst_css__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_Sunburst_css__WEBPACK_IMPORTED_MODULE_7__);
/**
 * Licensed to the Apache Software Foundation (ASF) under one
 * or more contributor license agreements.  See the NOTICE file
 * distributed with this work for additional information
...
const propTypes = {
  ...
  data: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.array),
  ...
  metrics: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.oneOfType([prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string, prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.object // The metric object
  ]))
};
...
function Sunburst(element, props) {
  ...
  const categoricalColorScale = _superset_ui_core__WEBPACK_IMPORTED_MODULE_2__["CategoricalColorNamespace"].getScale(colorScheme);
  let linearColorScale; // Helper + path gen functions

  const partition = d3__WEBPACK_IMPORTED_MODULE_0___default.a.layout.partition().size([2 * Math.PI, radius * radius]).value(d => d.m1);
  const arc = d3__WEBPACK_IMPORTED_MODULE_0___default.a.svg.arc().startAngle(d => d.x).endAngle(d => d.x + d.dx).innerRadius(d => Math.sqrt(d.y)).outerRadius(d => Math.sqrt(d.y + d.dy));
  const formatNum = Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_3__["getNumberFormatter"])(numberFormat || _superset_ui_core__WEBPACK_IMPORTED_MODULE_4__["default"].SI_3_DIGIT);
  const formatPerc = Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_3__["getNumberFormatter"])(_superset_ui_core__WEBPACK_IMPORTED_MODULE_4__["default"].PERCENT_3_POINT);
  ...
  function updateBreadcrumbs(sequenceArray, percentageString) {
    ...
    entering.append('svg:text').attr('x', (breadcrumbWidth + breadcrumbDims.tipTailWidth) / 2).attr('y', breadcrumbDims.height / 4).attr('dy', '0.35em').style('fill', d => {
      ...
      const col = d3__WEBPACK_IMPORTED_MODULE_0___default.a.hsl(colorByCategory ? categoricalColorScale(d.name) : linearColorScale(d.m2 / d.m1));
  ...
  function mouseleave() {
    ...
    arcs.selectAll('path').transition().duration(200).style('opacity', 1).style('stroke', null).style('stroke-width', null).each('end', function end() {
      d3__WEBPACK_IMPORTED_MODULE_0___default.a.select(this).on('mouseenter', mouseenter);
    });
  ...
  function createVisualization(rows) {
    ...
    if (metrics[0] !== metrics[1] && metrics[1]) {
      ...
      const ext = d3__WEBPACK_IMPORTED_MODULE_0___default.a.extent(nodes, d => d.m2 / d.m1);
      linearColorScale = Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_5__["default"])().get(linearColorScheme).createLinearScale(ext);
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return wrapSvgText; });
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! d3 */ "./node_modules/d3/d3.js");
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(d3__WEBPACK_IMPORTED_MODULE_0__);
/*
...
function wrapSvgText(text, width, adjustedY) {
  ...
  text.each(function each() {
    const d3Text = d3__WEBPACK_IMPORTED_MODULE_0___default.a.select(this);
...
/***/ "./node_modules/css-loader/index.js?!./node_modules/@superset-ui/legacy-plugin-chart-sunburst/esm/Sunburst.css":
/*!*********************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--7-1!./node_modules/@superset-ui/legacy-plugin-chart-sunburst/esm/Sunburst.css ***!
  \*********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
//# sourceMappingURL=41.9ed865ea.chunk.js.map