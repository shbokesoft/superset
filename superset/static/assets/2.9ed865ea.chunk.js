...
function nvd3Vis(element, props) {
  ...
  const drawGraph = function drawGraph() {
    ...
    Object(_utils__WEBPACK_IMPORTED_MODULE_16__["setAxisShowMaxMin"])(chart.y2Axis, yAxis2ShowMinMax || yAxisShowMinMax);
    ...
    if (isVizTypes(['line', 'area']) && useRichTooltip) {
      ...
      if (vizType === 'line') {
        ...
        // area chart
        chart.interactiveLayer.tooltip.contentGenerator(d => Object(_utils__WEBPACK_IMPORTED_MODULE_16__["generateAreaChartTooltipContent"])(d, _superset_ui_core__WEBPACK_IMPORTED_MODULE_11__["default"], yAxisFormatter, chart));
      }
    }

    if (isVizTypes(['compare'])) {
      chart.interactiveLayer.tooltip.contentGenerator(d => Object(_utils__WEBPACK_IMPORTED_MODULE_16__["generateCompareTooltipContent"])(d, yAxisFormatter));
    }
    ...
    if (chart.yAxis !== undefined || chart.yAxis2 !== undefined) {
      ...
      if (isTimeSeries && activeAnnotationLayers.length > 0) {
        // Formula annotations
        const formulas = activeAnnotationLayers.filter(a => a.annotationType === _vendor_superset_AnnotationTypes__WEBPACK_IMPORTED_MODULE_14__["default"].FORMULA).map(a => ({ ...a,
          formula: Object(mathjs__WEBPACK_IMPORTED_MODULE_3__["parse"])(a.value)
        }));
        let xMax;
        let xMin;
        let xScale;
    ...
    Object(_utils__WEBPACK_IMPORTED_MODULE_16__["wrapTooltip"])(chart);
    return chart;
...
/* harmony default export */ __webpack_exports__["default"] = (nvd3Vis);
...
const NVD3 = ({
  ...
  className: className
}, Object(_emotion_react__WEBPACK_IMPORTED_MODULE_6__["jsx"])(ReactNVD3, otherProps));

NVD3.propTypes = {
  className: prop_types__WEBPACK_IMPORTED_MODULE_3___default.a.string.isRequired
};
/* harmony default export */ __webpack_exports__["default"] = (Object(_superset_ui_core__WEBPACK_IMPORTED_MODULE_2__["styled"])(NVD3)`
...
var content = __webpack_require__(/*! !../../css-loader??ref--7-1!./nv.d3.css */ "./node_modules/css-loader/index.js?!./node_modules/nvd3-fork/build/nv.d3.css");
...
//# sourceMappingURL=2.9ed865ea.chunk.js.map